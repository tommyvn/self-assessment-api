...
object SummaryTypes {
  ...
  case object Incomes extends uk.gov.hmrc.selfassessmentapi.domain.SummaryType {
    ...
    override lazy val example: JsValue = toJson(uk.gov.hmrc.selfassessmentapi.domain.furnishedholidaylettings.Income.example)
  ...
  case object Expenses extends uk.gov.hmrc.selfassessmentapi.domain.SummaryType {
    ...
    override lazy val example: JsValue = toJson(uk.gov.hmrc.selfassessmentapi.domain.furnishedholidaylettings.Expense.example)
  ...
  case object PrivateUseAdjustments extends uk.gov.hmrc.selfassessmentapi.domain.SummaryType {
    ...
    override lazy val example: JsValue = toJson(uk.gov.hmrc.selfassessmentapi.domain.furnishedholidaylettings.PrivateUseAdjustment.example)
