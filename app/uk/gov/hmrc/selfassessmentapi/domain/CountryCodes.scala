...
object CountryCodes extends Enumeration {
  ...
  def details =
    Map(
      ...
      AZE -> CountryDetails("Azerbaijan", true),BHR -> CountryDetails("Bahrain", true),BGD -> CountryDetails("Bangladesh", true),BRB -> CountryDetails("Barbados", true),BLR -> CountryDetails("Belarus", true),
