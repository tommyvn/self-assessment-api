...
case class Liability(id: Option[LiabilityId] = None, taxYear: String, income: Income, incomeTax: CalculatedAmount, credits: Seq[Amount], class4Nic: CalculatedAmount, totalTaxDue: BigDecimal)
