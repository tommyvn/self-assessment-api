...
object SelfEmploymentsIncomeController extends uk.gov.hmrc.selfassessmentapi.controllers.SelfEmploymentsIncomeController {
  ...
  override def findById(saUtr: SaUtr, taxYear: String, seId: SelfEmploymentId, seIncomeId: SelfEmploymentIncomeId) = Action.async { _ =>
    Future.successful(NotImplemented(Json.toJson(ErrorNotImplemented)))
  }
  ...
  override def update(saUtr: SaUtr, taxYear: String, seId: SelfEmploymentId, seIncomeId: SelfEmploymentIncomeId) = Action.async(parse.json)  { _ =>
    Future.successful(NotImplemented(Json.toJson(ErrorNotImplemented)))
  }

  override def delete(saUtr: SaUtr, taxYear: String, seId: SelfEmploymentId, seIncomeId: SelfEmploymentIncomeId) = Action.async { _ =>
    Future.successful(NotImplemented(Json.toJson(ErrorNotImplemented)))
  }
